        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-foreground text-sm font-black uppercase tracking-[0.2em]">Engineering Legacy</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8 lg:mb-10 text-foreground leading-tight tracking-tight font-black">
              Defining the <br />
              Standard of <br />
              <span className="text-accent">Strength.</span>
            </h2>
            <p className="text-lg text-muted mb-12 leading-relaxed font-semibold">
            ...
            <div className="space-y-5">
              {['ISI Certified Production', 'High-Density V-Casting', 'Automated Curing Systems'].map((item) => (
                <div key={item} className="flex items-center gap-4 text-base font-black text-foreground">
          ...
          >
            ...
            <div className="col-span-2 p-8 md:p-12 bg-card border border-border mt-4 md:mt-8 shadow-xl shadow-primary/5">
